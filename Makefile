...
GRAPHITE	= -fgraphite -fgraphite-identity -fivopts -ftree-loop-linear -ftree-loop-vectorize -ftree-loop-distribute-patterns -ftree-slp-vectorize -ftree-partial-pre -ftree-vectorize -floop-parallelize-all -floop-interchange -floop-strip-mine -floop-block -floop-unroll-and-jam -pipe -fmodulo-sched -fmodulo-sched-allow-regmoves -fgcse-las -fgcse-after-reload -fgcse-lm -fgcse-sm -fsched-spec-load -fsched-pressure -fsingle-precision-constant -fpredictive-commoning -fvect-cost-model -ffast-math -fno-delete-null-pointer-checks -funswitch-loops -flive-range-shrinkage -fvariable-expansion-in-unroller -fprofile-correction -fbranch-target-load-optimize -fbranch-target-load-optimize2 -fbtr-bb-exclusive -fstdarg-opt
HOSTCC       = ccache gcc
HOSTCXX      = ccache g++
...
CFLAGS_KERNEL	= $(GRAPHITE) -mcpu=cortex-a57.cortex-a53 -mtune=cortex-a57.cortex-a53
